            ...
            <div className="container">
                ...
                <div className="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                    ...
                    <a href="index.html" className="logo d-flex align-items-center w-auto">
                        <img src="https://vibescom.org/vibesdesign/ligo/assets/img/ligo_logo.jpg"  alt="ligo cms"/>
                        <span className="d-none d-lg-block">LIGO</span>
                    </a>
                    </div>
                    ...
                    <div className="card-body">
                        ...
                        <div className="col-12">
                            <Link href='/'><button className="btn btn-primary w-100" type="submit">Login</button></Link>
                        </div>
                        <div className="col-12">
